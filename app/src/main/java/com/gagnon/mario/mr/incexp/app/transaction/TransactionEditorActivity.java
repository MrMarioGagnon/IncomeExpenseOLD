...
public class TransactionEditorActivity extends AppCompatActivity implements ItemStateChangeListener {
    ...
    private TransactionRepositorySynchronizer mRepositorySynchronizer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRepositorySynchronizer = new TransactionRepositorySynchronizer(getContentResolver(), IncomeExpenseContract.TransactionEntry.CONTENT_URI, ItemRepositorySynchronizerMessageBuilder.build(this, TransactionEditorActivity.class.getSimpleName()));
        ...
        if (savedInstanceState == null) {
            ...
            if (bundle != null) {
                transaction = (Transaction) bundle.getSerializable("item");
            }
            ...
            arguments.putSerializable("item", transaction);
            //arguments.putSerializable("names", IncomeExpenseRequestWrapper.getAvailableAccountName(getContentResolver(), account));
            //arguments.putSerializable("contributors", IncomeExpenseRequestWrapper.getAvailableContributors(getContentResolver()));
            //arguments.putSerializable("categories", IncomeExpenseRequestWrapper.getAvailableCategories(getContentResolver()));
...
//    }
    ...
    public void onItemStateChange(ItemStateChangeEvent event) {
        ...
        Transaction transaction = (Transaction) event.getItem();
        ...
        try {
            mRepositorySynchronizer.Save(transaction);
